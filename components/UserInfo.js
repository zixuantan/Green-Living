  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Your Monthly Goals (Resource Use Limit)</Text>
        <Text style={styles.goalText}>Water (litres/month): </Text>
        <TextInput style={styles.goalText} keyboardType="numeric" placeholder="Enter Water Goal"/>

        <Text style={styles.goalText}>Energy (kWh/month): </Text>
        <TextInput style={styles.goalText} keyboardType="numeric" placeholder="Enter Energy Goal"/>
      </View>
